...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AngleGradientBorderView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/erusso1/AngleGradientBorderView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'erusso1' => 'ephraim.s.russo@gmail.com' }
  s.source           = { :git => 'https://github.com/erusso1/AngleGradientBorderView.git', :tag => s.version.to_s }
